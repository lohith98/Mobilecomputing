...
def draw_box_on_image(num_hands_detect, score_thresh, scores, boxes, im_width, im_height, image_np, color_image, count, frame_path, video_name, rotateCode):
    ...
    for i in range(num_hands_detect):
        if (scores[i] > score_thresh):
            ...
            try:
                ...
                temp_image = correct_rotation(temp_image, rotateCode)
